...
-   The [IDML-JSON-Converter](https://www.idml.dev/en/json-idml-converter-php.html) library that allows converting Adobe InDesign Markup Language Files (IDML) into JSON and JSON into IDML.
